...
import { SiPython, SiReact, SiNextdotjs, SiDocker, SiMicrosoftazure, SiKubernetes } from 'react-icons/si'
...
export default function ProjectShowcase() {
  ...
  return (
    <section>
      <h2 className="text-2xl font-bold mb-4">Proyectos Realizados</h2>
